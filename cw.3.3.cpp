...
int main()
{
	...
	int flag=0;							//zmienna pzechowujaca informacje, czy w tablicy istnieje jakas liczba spelniajaca warunek
	...
	if(flag==1)
	{
		cout << "W tej tablicy istnieje liczba podzielna przez 7" << endl;
	}
	else
	{
		cout << "W tej tablciy nie istnieje zadna liczba podzielna przez 7" << endl;
	}
